...
namespace Projeto06.Controllers
{
    public class ClienteController
    {
        ...
        public void ExecutarMenu()
        {
            ...
            Console.WriteLine("(2) - ATUALIZAR CLIENTES");
        ...
        //metodo para executar o cadastro de uum cliente
        ...
        public void AtualizarCliente()
        {
            try
            {
                ...
                if (cliente != null)
                {
                    ...
                    //atualizando o clinete no banco de dados
        ...
        public void ConsultarClientes()
        {
            try
            {
                ...
                //consultado todos os clientes cadastrados no banco de dados
                var clienteRepository = new ClienteRepository();
